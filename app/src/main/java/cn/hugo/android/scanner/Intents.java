...
public final class Intents {
  ...
  public static final class Scan {
    /**
     * Send this intent to open the Barcodes app in scanning mode, find a barcode, and return_iv
     * the results.
     */
     ...
     * to return_iv the content of any UPC extension barcode that was also found. Only applicable
